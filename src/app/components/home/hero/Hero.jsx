...
import user from "../../../asset/iam.jpeg"
...
const Hero = () => {
    ...
    const socialIcon = [
        { icon: <TiSocialFacebook size={28} />, link: 'https://www.facebook.com/share/1FKKDpdHs1/', },
        { icon: <TiSocialLinkedin size={28} />, link: 'https://www.linkedin.com/in/shahul-hameed-k-200560276?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app', },
        { icon: <TiSocialInstagram size={28} />, link: 'https://www.instagram.com/i_m_sha__?igsh=MWtzZnpvcDBya3ZwdA==', },
        { icon: <FaWhatsapp size={28} />, link: 'https://wa.me/+91 9345890475', },
    ];
    const textVariants = {
                ...
                >
                    ...
                    >
                        ...
                        <h1 className='sm:text-5xl text-5xl lg:text-6xl xl:text-7xl font-semibold'>
                            I am <span className='name' > SHAHUL </span>
                        </h1>
                        ...
                        >
                            ...
                            <a href="https://drive.google.com/file/d/1F9mrmeUR4zmDRs666s4i25m2NIQmIgd7/view?usp=drivesdk">
