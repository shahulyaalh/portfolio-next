...
const Footer = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            ...
            const formspreeEndpoint = 'https://formspree.io/f/xkgozqdq';
                ...
                <div className="flex flex-col-reverse md:flex-row xl:flex-row h-full justify-between xl:mt-16">
                    ...
                    >
                            ...
                            <ul>
                                <li className="flex items-start gap-x-5 mt-10 xl:mt-20">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg text-primary-white/80">Tamil Nadu, India.</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-x-5 mt-10 lg:mt-14">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg text-primary-white/80">
                                            <a href="tel:(+92)1234567" className="hover:text-gray-300 transition">(+91) 9345890475</a>
                                            <br />
                                            <a href="mailto:shahulyaalh@gmail.com" className="hover:text-gray-300 transition">shahulyaalh@gmail.com</a>
                                        </p>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div className="text-primary-green text-sm xl:text-xl mb-5 xl:mb-0 mt-10 xl:mt-64">
                            Copyright © 2024 Shahul Hameed. All rights reserved.
                        </div>
                    </motion.div>
                    <motion.div
